...
names(list_6strict) <- c("This study", "Alfonso-Parra", "Camargo")

list_6un <- list(DE6$gene_id, alonso$gene_id, pascini$gene_id)
names(list_6un) <- c("This study", "Alonso", "Pascini")

list_24strict <- list(DE24$gene_id, alfpar_24h$gene_id, amaro$gene_id,
                      camargo_24h$gene_id)
names(list_24strict) <- c("This study", "Alfonso-Parra", "Amaro", "Camargo")

list_24un <- list(DE24$gene_id, alonso$gene_id, pascini$gene_id)
names(list_24un) <- c("This study", "Alonso", "Pascini")
```
